...
public class Cards {
	...
	public static final Card ROTATE_RIGHT =
			register(new Card("Rotate right", 18, texture("rotate_right.jpg"), RotateRight::new));
	public static final Card ROTATE_LEFT =
			register(new Card("Rotate left", 18, texture("rotate_left.jpg"), RotateLeft::new));
	public static final Card U_TURN =
			register(new Card("U-Turn", 6, texture("u_turn.jpg"), RotateRight::new, RotateRight::new));
