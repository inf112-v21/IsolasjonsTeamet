...
public class Tiles {
    ...
    public static final TileType WALL =  new TileType();

    public static final TileType HOLE =  new TileType();

    public static final TileType LASER =  new TileType();

    public static final TileType FLAG =  new TileType();

    public static final TileType REPAIR_SITES_HAMMER_WRENCH =  new TileType();

    public static final TileType REPAIR_SITES_WRENCH =  new TileType();
